...
ARTIFACTS = ROOT / "artifacts/failure-targeted-preservation-sft-smoke-v12"
...
PRE_REGISTRATION_REVISION = "b689446"
DATA_REVISION = "3b4f76f"
CONFIG_SHA256 = (
    "82ad3ca17fc23e5722fead74cf9387364"
    "183db2cda8493ed02474e0ef60d2d02"
)
...
def main() -> None:
    ...
    if passed:
        raise SystemExit("v12 unexpectedly satisfies its frozen local gate")

    report = {
        "schema_version": "nano_train_public_sft_smoke_v12",
        ...
        "configuration": {
            ...
            "failure_targeted_examples_seen": 19,
            "failure_targeted_family_examples_seen": {
                "packing_efficiency_effective_volume": 5,
                "percentage_increase_total_composition": 7,
                "weighted_recurring_schedule_total": 7,
            },
        ...
        "versus_v11": {
            ...
            "any_semantic_regression": any(
                row["regressed_sample_ids"] for row in deltas.values()
            ),
        },
        "evaluation_boundary": {
        ...
        "decision": {
            ...
            "rl_allowed": False,
            "next_action": (
                "Reject v12. Preserve v11 as the current candidate. Analyze "
                "why broad numeric replacement causes choice and strict "
                "regression before changing any data, dose, or gate."
            ),
        },
    }
    ...
    markdown = f"""# Failure-Targeted Preservation SFT Smoke v12 Result
...
"""
    ...
    (output / "failure_targeted_preservation_sft_smoke_v12.public.json").write_text(
        json.dumps(report, indent=2, sort_keys=True) + "\n",
        encoding="utf-8",
    )
    (output / "failure_targeted_preservation_sft_smoke_v12.md").write_text(
        markdown,
        encoding="utf-8",
    )
    print(
